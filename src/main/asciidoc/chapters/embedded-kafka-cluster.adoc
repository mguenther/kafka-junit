...
Set<Integer> leaders = cluster.getLeaderAndIsr("test-topic")
    .values()
    .stream()
...
Set<Integer> leadersAfterDisconnect = cluster.getLeaderAndIsr("test-topic")
    .values()
    .stream()
    .map(LeaderAndIsr::leader)
    .collect(Collectors.toSet());
...
Set<Integer> leadersAfterReconnect = cluster.getLeaderAndIsr("test-topic")
    .values()
    .stream()
    .map(LeaderAndIsr::leader)
    .collect(Collectors.toSet());
