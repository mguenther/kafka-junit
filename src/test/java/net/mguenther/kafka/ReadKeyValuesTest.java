...
public class ReadKeyValuesTest {
    ...
    public void shouldPreserveConstructorArguments() {
        ...
        final ReadKeyValues<String, String> readRequest = ReadKeyValues.<String, String>from("test").useDefaults();
    ...
    public void unlimitedShouldNotRestrictLimitSetting() {
        ...
        final ReadKeyValues<String, String> readRequest = ReadKeyValues.<String, String>from("test")
                .withLimit(1)
                .unlimited()
                .build();
