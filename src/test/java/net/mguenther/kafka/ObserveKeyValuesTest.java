...
public class ObserveKeyValuesTest {
    ...
    public void shouldPreserveConstructorArguments() {
        ...
        final ObserveKeyValues<String, String> observeRequest = ObserveKeyValues.<String, String>on("test", 10).useDefaults();
    ...
    public void observeForShouldOverrideDefaultObservationTime() {
        ...
        final ObserveKeyValues<String, String> observeRequest = ObserveKeyValues.<String, String>on("test", 10)
